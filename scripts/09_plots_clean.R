...
res_path <- "path/output/analysis"
#dir.create("path/Figures_manuscript")
fig_path <- "path/Figures_manuscript"
...
############################### spatial patterns of % orientalis genotype at t = X (CURERNT SUPPLEMENTARY FIGURE)
...
####################################### time to reach X % NW and X % hybrids  (CURRENT SUPPLEMENTARY FIGURE)
...
# get final year NW as reference 100%
...
## plot (current supplementary figure)
ggplot(dt_final,
...
####################################### plot NW and hybrid % at year X (CURRENT FIGURE 3 (SUBSET) and SUPPLEMENTARY (FULL VERSION))
...
## add the neutral data range as a shaded color background in the other facets: 
...
# plot NW and hybrid proprotions at t = X (all combinations)
...
# subset selection against E.b (MAIN FIGURE?)
...
## plot results for both years (CURRENT FIGURE 4)
