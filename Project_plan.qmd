...
Fixed (species-specific) parameters: Trasobares et al., 2016; Maringer et al., 2021; Wilkens et al., 2021
...
2. stage survival from COMPADRE matrix, fecundity value (1000) and S1 (survival of Stage1) were previously tested in Stefaninin et al., in prep (previous paper)
...
2.  patch number and grid: 25 x 25 grid, each patch is 16\^2 m.

3.  patch carrying capacity (patch_nbfem) = from literature: 
    - 50 in Waldi (Stefanini et al., in review), 
    - 800 in Allenwiller (Stefanini et al., in review),  
    - roughly 16-48 in favorable conditions in Dobrovolný et al., 2010 (https://jfs.agriculturejournals.cz/pdfs/jfs/2010/12/04.pdf?utm_source=chatgpt.com)
    - max found 8750/ha (but very variable depending on the conditions) in Axer 2021 (https://link.springer.com/article/10.1007/s10342-021-01377-w?utm_source=chatgpt.com)
    - more than 10000/ha in one study in Poland (10.3161/15052249PJE2015.63.2.009)

  ---> 8-16 seedlings = moderate regeneration scenario, 50 seedlings = high regeneration scenario

4.  seed and pollen dispersal matrix (average from literature) —\>*seed_disperse_connectivity_matrix etc*
    -  check dispersal gradient in https://iforest.sisef.org/contents/?id=ifor1581-008&utm_source=chatgpt.com
    - 20 m radius for the seed falling according to Wagner 1999 - Wagner S (1999) The initial phase of natural regeneration in mixed ash-beech stands—ecological aspects. Sauerländer;
    and  Kutter and Gratzer 2006 (Kutter M, Gratzer G (2006) New methods for estimating seed dispersal distances of forest trees on the example of the spread of Picea abies, Abies alba and Fagus sylvatica. Centralblatt für das gesamte Forstwesen 123:103–120); 
    and Millerón et al. 2013 (https://doi.org/10.1111/mec.12200 )
    
5.  selfing (from literature) —\> *mating_system 4, mating_proportion*

6.  competition model and competition coefficient??? —-\> b
...
b <- c(0.5,0.5,0.5) # shape parameter from NMpi2 
d <- c(200, 400, 800)  # mean dispersal distance from NMpi2 and reduced dispersal 
## check the curves
x <- 1:1000 
results <- data.frame()
for (i in 1:length(d)) {
