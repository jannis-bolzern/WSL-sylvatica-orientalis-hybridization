...
3.  patch carrying capacity (patch_nbfem) = from literature: 
    ...
    - max found 8750/ha (but very variable depending on the conditions) in Axer 2021 (https://link.springer.com/article/10.1007/s10342-021-01377-w)
...
4.  seed dispersal distance and shape parameter: 
...
5.  pollen dispersal distance and pollen shape paraneter:
...
5.  selfing ( *mating_system 4, + mating_proportion* ): 
    -  0.0073 in Allenwiller
    -  0.0032 in Wäldi
    -  0.00036 in Westergren 2023

6.  competition model and competition coefficient (regulation_by_competition)
