...
2.    plot our main figure x = configuration_oriproportion; y = hybrid_proportions  and facet_grid for K and B. We compare the distirbutions of the data with statistical test (F-test, ANOVA). 

--> is the significance changing?
