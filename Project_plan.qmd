...
-\> in total, 3 x 3 = 9 spatial configurations? 
-\> NB: testing only set of simulations starting with European beech?

4. For each spatial configuration, create the input files (matrices) and the init files. 

5. Run the simulations 

-\>  REPLICATES: **first exploratory test with 3-5 replicates, final simulations with 30 replicates, after everything is defined**
-\>  GENERATIONS (years): burnin simulations approx 20 to let E. beech grow and reproduce a bit, then actual simulations for 300-500 years.
