...
set_ini_param <- function(lines, key, value) {
  ...
  # remove any additional occurrences (CRITICAL for clean templates + no accidental sweeps)
...
# drop lines matching regex (e.g. parameters unsupported in NEMO-age)
...
# logging
burnin_lines <- set_ini_param(burnin_lines, "stat_log_time", LOG_EVERY)
...
run_template <- set_ini_param(run_template, "stat_log_time", LOG_EVERY)
